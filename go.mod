...
require (
	...
	github.com/DataDog/datadog-agent/pkg/quantile v0.31.0-rc.6
	github.com/DataDog/datadog-agent/pkg/util/log v0.31.0-rc.6
	github.com/DataDog/datadog-agent/pkg/util/winutil v0.31.0-rc.6
